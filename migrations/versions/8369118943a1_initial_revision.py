...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=128), nullable=True),
        sa.Column("password", sa.String(length=128), nullable=True),
        sa.Column("stu_name", sa.String(length=128), nullable=True),
        sa.Column("stu_id", sa.String(length=128), nullable=True),
        sa.Column("stu_class", sa.String(length=128), nullable=True),
        sa.Column("email", sa.String(length=128), nullable=True),
        sa.Column("type", sa.String(length=80), nullable=True),
        sa.Column("secret", sa.String(length=128), nullable=True),
        sa.Column("website", sa.String(length=128), nullable=True),
