...
class UserBaseForm(BaseForm):
    ...
    stu_name = StringField("姓名", validators=[InputRequired()])
    stu_id = StringField("学号", validators=[InputRequired()])
    stu_class = StringField("班级（如：21级软件工程xx班）", validators=[InputRequired()])
